...
>
  ...
  {#if currentState === 0}
    ...
    >
      ...
      />
      <img
        class="w-1/5 sm:w-28 object-cover mb-10"
        src="/365days/logo.png"
        alt="logo"
      />
  ...
  {#if currentState === 1}
    <div
      class="w-full max-w-xl h-full flex flex-col justify-start items-center absolute"
      transition:fade
    >
      <img
      ...
      <p class="text-xs w-full text-start px-12 text-gray-900">
        <b>@365d_album</b> began as a photo collection that chronicled an entire
        year, capturing moments from each of the 365 days.
        <br />
        <br />
        The journey started on 18/08/2022 and concluded on 18/08/2023. While I cherished
        the album, there comes a point when all things must come to an end.
        <br />
        <br />
        In order to immortalize the album on the internet, I transformed it into
        a book of answers. Each photo now serves as a response to your questions,
        providing guidance through the quotes they hold.
        <br />
        <br />
        On this website, you have the opportunity to ask a question, and in return,
        it will present you with a random photo from the album, accompanied by a
        quote that may serve as your guiding light.
        <br />
        <br />
  ...
  {#if currentState === 2}
    <div
      class="w-full h-full max-w-xl flex flex-col justify-center items-center "
      transition:fade
    >
    ...
    >
      <div class="w-3/4 flex flex-col space-y-1 my-10 ">
        ...
        <span class="mt-5 text-center text-xs"
          >Do you feel special today? Do you need a booster or some sort of
          universe signal? Well, look below.</span
        >
      </div>
      <img
      ...
      <div class="w-3/4 flex flex-col">
        <div
          class="w-full flex flex-row justify-between z-20"
          on:click={onShare}
        >
          <div class="">
  ...
  {#if currentState === 4}
    <div
      class="w-full h-full max-w-xl flex flex-col justify-start items-center"
      transition:fade={{ duration: 1000 }}
    >
      <img class="w-1/5 sm:w-28 object-cover my-10" src="/365days/logo.png" />
      <img
        class="w-3/4 object-cover animation-float"
        src="/365days/avatar.png"
      />
      <div class="w-3/4 flex flex-col">
        <p class="text-xl">Thank You</p>
        <p class="text-xs mt-4">
          The <span class="font-bold">"365 days" Photo Album</span> is a small
          project made by Binh Pham, the fat guy in the picture. He is a
          Fullstack Developer who just happens to be good in Art and several
          other things.
          <br />
          <br />
          If you are in need of help, please don't use this website as a guide. Talk
          to your friends or if you need a pal, strike a conversation with me.
          <br />
          <br />
          If there are bugs on the website, please consider them as features. This
          website will not be updated, immortalizing it as a time capsule on the
          Internet... unless the Quote's API went down.
          <br />
          <br />
